            ...
            <div class="tab-pane active" id="admin">
                <nav class="sidebar-nav">
                    <ul class="main-menu metismenu">
                        ...
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-organization"></i><span>Brand Management</span> </a>
                            <ul>
                        ...
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-bag"></i><span>Product Management</span> </a>
                            <ul>
                        ...
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-basket"></i><span>Cart Management</span> </a>
                            <ul>
                                <li><a href="departments.html">All Cart</a></li>
                                <li><a href="add-departments.html">Add Cart</a></li>
                            </ul>
                        </li>

                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-layers"></i><span>Order Management</span> </a>
                            <ul>
                                <li><a href="departments.html">All Post</a></li>
                                <li><a href="add-departments.html">Add Post</a></li>
                            </ul>
                        </li>

                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-organization"></i><span>Post Category</span> </a>
                            <ul>
                                <li><a href="departments.html">All Post Category</a></li>
                                <li><a href="add-departments.html">Add Post Category</a></li>
                            </ul>
                        </li>

                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-tag"></i><span>Post Tag</span> </a>
                            <ul>
                                <li><a href="departments.html">All Post Tag</a></li>
                                <li><a href="add-departments.html">Add Post Tag</a></li>
                            </ul>
                        </li>
...
{{--                        </li>--}}
                        ...
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-star"></i><span>Review Management</span> </a>
                            <ul>
                                <li><a href="departments.html">All Review Management</a></li>
                                <li><a href="add-departments.html">Add Review Management</a></li>
                            </ul>
                        </li>
                        ...
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-star"></i><span>Comments Management</span> </a>
                            <ul>
                                <li><a href="departments.html">All Review Management</a></li>
                                <li><a href="add-departments.html">Add Review Management</a></li>
                            </ul>
