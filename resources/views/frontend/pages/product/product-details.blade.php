            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="single_product_desc">
                        ...
                        <h6 class="product-price"><small><del class="text-danger"></del></small></h6>
                    ...
                    <div class="you_make_like_slider owl-carousel">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                @php
                                $photo = explode(',',$relatedProduct->photo)
                                @endphp
                                <img class="normal_img" src="{{$photo[0]}}" alt="{{$relatedProduct->title}}">
{{--                                <img class="hover_img" src="img/product-img/new-1.png" alt="">--}}

                                <!-- Product Badge -->
                                <div class="product_badge">
                                    <span>{{$relatedProduct->condition}}</span>
                                </div>
                            ...
                            <div class="product_description">
                                ...
                                <div class="product_add_to_cart">
                                    <a href="#" data-quantity="1" data-product-id="{{$relatedProduct->id}}" class="add_to_cart" id="add_to_cart{{$relatedProduct->id}}"  ><i class="icofont-shopping-cart"></i> Add to Cart</a>
                                </div>
                                ...
                                <p class="brand_name">{{\App\Models\Brand::where('id',$relatedProduct->brand_id)->value('title')}}</p>
                                <a href="{{route('product.details',$relatedProduct->slug)}}">{{ucfirst($relatedProduct->title)}}</a>
                                <h6 class="product-price">${{number_format($relatedProduct->offer_price,2)}} <small><del class="text-danger">${{number_format($relatedProduct->price,2)}}</del></small></h6>
