                        ...
                        <div class="row h-100 align-items-center">
                            <div class="col-7 col-md-8">
                                <div class="welcome_slide_text">
                                    ...
                                    <h4 data-animation="fadeInUp" data-delay="600ms">{!! html_entity_decode($banner->summary) !!}</h4>
                                    <a href="{{$banner->slug}}" class="btn btn-primary" data-animation="fadeInUp" data-delay="1s">Shop Now
                                        </a>
                                </div>
                            </div>
                            <div class="col-5 col-md-4">
                                <div class="welcome_slide_image">
                                    <img src="{{$banner->photo}}" alt="" data-animation="bounceInUp" data-delay="500ms">
                    ...
                    <div class="new_arrivals_slides owl-carousel">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="{{$new_product->photo}}" alt="{{$new_product->title}}">
